...
#Datos persona 2
nombre_apellido2= input("Ingresa el nombre de la primer persona: ")
direccion2 = input("Ingresa la direccion de la primer persona: ")
edad2 = int(input("Ingresa la edad de la primer persona:"))
#Datos persona 3
nombre_apellido3= input("Ingresa el nombre de la primer persona: ")
direccion3 = input("Ingresa la direccion de la primer persona: ")
edad3 = int(input("Ingresa la edad de la primer persona:"))
#Datos persona 4
nombre_apellido4= input("Ingresa el nombre de la primer persona: ")
direccion4 = input("Ingresa la direccion de la primer persona: ")
edad4 = int(input("Ingresa la edad de la primer persona:"))
