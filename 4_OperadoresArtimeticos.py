...
print(f"el resultado de la suma es: {suma}") #Otra manera de concatenar con la F y el resultado entre llaves.
#esto se llama Interpolacion de cadenas
operador_1 = 10
operador_2 = 3
 ...
 *Recuerde la formula Area = largo * ancho // Perimetro = (largo + ancho) * 2
