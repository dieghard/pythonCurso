#! Realizar un programa que permita ingresar solo numeros, si no se cumple este requisito, 
#que me de la hasta 2 oportunidades más y me muestre la cantidad de veces que lo hice mal.
continuar = 0
